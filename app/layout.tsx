    ...
    <html lang="en" className={inter.variable}>
      ...
      <body className="bg-black text-white antialiased">
        ...
        <a href="https://wa.me/447700900000" target="_blank" rel="noopener noreferrer"
          ...
          <span className="absolute inset-[-6px] rounded-full opacity-40 group-hover:opacity-70 transition-opacity"
            style={{ background: 'radial-gradient(circle, rgba(37,211,102,0.4) 0%, transparent 70%)', filter: 'blur(8px)' }}/>
          <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:scale-110 transition-all duration-300">
