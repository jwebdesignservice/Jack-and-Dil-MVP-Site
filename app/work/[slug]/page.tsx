...
const caseStudies: Record<string, CaseStudy> = {
  ...
  'speed-read': {
    title: 'Speed Read',
    tagline: 'An RSVP-powered speed reading tool that eliminates eye movement and trains your brain to read at up to 1200 WPM.',
    ...
    challenge: 'The founder wanted a clean, science-backed speed reading tool that used RSVP (Rapid Serial Visual Presentation) to eliminate the two biggest bottlenecks in reading — eye movement and subvocalization — without the clutter of existing tools on the market.',
    approach: 'Built the core RSVP reader engine first, then the story library and training mode. Designed the UI to be minimal and distraction-free so the reading experience itself was the focus. Browser extension added last to let users speed-read any webpage.',
    approachCards: [
      { icon: '⚡', title: 'Engine First', desc: 'Core RSVP word-flash engine built and tuned before any other features.' },
      { icon: '📚', title: 'Story Library', desc: 'Curated content library across 10 categories so users can start instantly.' },
      { icon: '🧠', title: 'Training Mode', desc: 'Adaptive speed ramping that gradually pushes users past their comfort zone.' },
    ],
    features: [
      { icon: '⚡', title: 'RSVP Reader', desc: 'Words flash at a fixed focal point — zero eye movement, maximum speed.' },
      { icon: '📈', title: 'Training Mode', desc: 'Auto-ramps from your start speed to target WPM as you read.' },
      { icon: '📚', title: 'Story Library', desc: '10 curated categories — science, history, philosophy, business, and more.' },
      { icon: '🌐', title: 'Browser Extension', desc: 'Speed read any text on any website with Alt+S.' },
      { icon: '📊', title: 'Progress Tracking', desc: 'Words read, average WPM, and peak speeds tracked across sessions.' },
      { icon: '🌙', title: 'Dark Mode', desc: 'Automatic theme detection for comfortable reading day or night.' },
    ],
    images: ['/Images/work/speedread-laptop.png', '/Images/work/speedread-phone.png', '/Images/work/speedread-library.png', '/Images/work/speedread-reader.png'],
    results: {
      stats: [
        { value: '7', label: 'Days delivered' },
        { value: '1200', label: 'Max WPM' },
        { value: '85%', label: 'Retention rate' },
        { value: '3×', label: 'Avg speed increase' },
      ],
      quote: "I went from 250 WPM to over 600 in two weeks of training. The app is beautifully simple — it just gets out of the way and lets you read.",
      author: 'Early user, Speed Read',
    },
    tech: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Vercel', 'Browser Extension API'],
    liveUrl: 'https://speedreadtool-one.vercel.app/',
  },
  'ams-tool': {
    title: 'AMS Tool',
