  ...
  return (
    <footer className="bg-[#050505] relative z-10">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:hello@launchfast.dev"
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:hello@launchfast.dev" className="flex items-center gap-2 text-neutral-500 hover:text-orange-400 transition-colors text-sm">
        ...
        {/* Divider */}
        <div className="mt-12 mb-8 h-px bg-gradient-to-r from-transparent via-neutral-800 to-transparent"/>
      ...
      {/* Large "LaunchFast" text — full width, scales to viewport */}
      <div className="overflow-hidden pb-4">
        <div className="text-center leading-none select-none pointer-events-none"
          style={{ fontSize: 'min(18vw, 220px)', fontWeight: 900, letterSpacing: '-0.04em', color: 'transparent', WebkitTextStroke: '1px rgba(249,115,22,0.15)' }}>
          LaunchFast
        </div>
      </div>
    </footer>
