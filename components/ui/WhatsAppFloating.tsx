// WhatsApp floating CTA. Server component — pure HTML/CSS, no client JS.
// Pulled out of app/layout.tsx so the layout module stays small (less JS to
// hydrate) and so this big inline SVG isn't reparsed on every change.
export default function WhatsAppFloating() {
  return (
    <a
      href="https://wa.me/447917328155?text=Hi%2C%20I%27m%20interested%20in%20your%20MVP%20services"
      target="_blank"
    ...
    >
      ...
      <span
        className="absolute inset-[-8px] rounded-full opacity-50 group-hover:opacity-80 transition-opacity"
        style={{
      ...
      <span
        ...
        style={{
          ...
          boxShadow:
            'inset 0 1px 0 0 rgba(255,255,255,0.18), 0 8px 32px -8px rgba(37,211,102,0.55)',
        }}
      >
        <svg
          width="30"
